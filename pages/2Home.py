...
with st.container():
    ...
    with col1:
        ...
        """)
    with col2:
        img1=Image.open('images/asd_child.jpg')
...
with st.container():
    ...
    with col1:
        ...
        """)
    with col2:
        img1=Image.open('images/causes-of-autism.png')
...
with st.container():
    ...
    with col2:
        img=Image.open('images/autism.png')
        st.image(img,caption="Signs of ASD")
        img1=Image.open('images/Strategies.jpeg')
...
with st.container():
    ...
    with right_column:
        img=Image.open('images/autism-stats-1.jpg')
        st.image(img,width=350,caption="ASD ststistics")
        img1=Image.open('images/autism-stats-2.png')
...
c1.image(im,caption="")
im1=Image.open('images/Worlds.png')
